...
create table course505
 ...
 create table instructor505
   (ID        varchar(5),
    ...
    alter table instructor505 rename facutly to name;
...
CREATE TABLE Register1(
		stu_ID int,
		course_id varchar(10),
		FOREIGN KEY(stu_ID) REFERENCES Student on delete cascade on update cascade,
		FOREIGN KEY(course_id) REFERENCES course505 on delete cascade on update cascade,
...
INSERT into student_123(stu_ID, stu_name, stt, dept_name, tuition_fee, cgpa) VALUES (500,'Vinay','TL','CSE',20,8.4),(506,'srinivas','AP','CSE',300,8.9),(508,'venu','AP','CSE',40,9.8),(255,'pramod','TL','CSE',100,10.0),(254,'ghanta','AP','CSE',60,9.6),(502,'pavan','KL','CSE',80,10.0);
INSERT into student_123(stu_ID, stu_name, stt, dept_name, tuition_fee, cgpa) VALUES (504,'baldo','TN','CSE',30000,8.9);
INSERT into student_123(stu_ID, stu_name, stt, dept_name, tuition_fee, cgpa) VALUES (505,'ronaldo','MH','CSE',50000,6.0);

select * from student_123 where stu_name like 'v%';
select * from student_123 where dept_name='CSE';
...
select count(stu_name) from student_123 where dept_name = 'CSE';
